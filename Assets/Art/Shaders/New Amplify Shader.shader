...
Shader "New Amplify Shader"
{
	...
	SubShader
	{
		...
		{
			float4 color1 = IsGammaSpace() ? float4(0.6698113,0.2116856,0.2116856,0) : float4(0.4061945,0.03686322,0.03686322,0);
			o.Albedo = color1.rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18935
294;550;1348;449;809.5749;228.9121;1.6;False;False
Node;AmplifyShaderEditor.ColorNode;1;-283.1749,-4.912079;Inherit;False;Constant;_Color0;Color 0;0;0;Create;True;0;0;0;False;0;False;0.6698113,0.2116856,0.2116856,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=B6B2B178BC3B703E7227CF55892F2684B09E0AE3